(() => {
  ...
  var require_three_shim = __commonJS({
    "js/three-shim.js"(exports, module) {
      module.exports = window.THREE;
    }
  });

  // node_modules/three-csg-ts/lib/cjs/NBuf.js
  var require_NBuf = __commonJS({
    "node_modules/three-csg-ts/lib/cjs/NBuf.js"(exports) {
      "use strict";
  ...
  // node_modules/three-csg-ts/lib/cjs/Node.js
  var require_Node = __commonJS({
    "node_modules/three-csg-ts/lib/cjs/Node.js"(exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
      exports.Node = void 0;
  ...
  // node_modules/three-csg-ts/lib/cjs/Vector.js
  var require_Vector = __commonJS({
    "node_modules/three-csg-ts/lib/cjs/Vector.js"(exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
      exports.Vector = void 0;
      var three_1 = require_three_shim();
  ...
  // node_modules/three-csg-ts/lib/cjs/Plane.js
  var require_Plane = __commonJS({
    "node_modules/three-csg-ts/lib/cjs/Plane.js"(exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
      ...
      var Plane = class _Plane {
          ...
          switch (polygonType) {
            ...
            case SPANNING: {
              ...
              for (let i = 0; i < polygon.vertices.length; i++) {
                ...
                if ((ti | tj) == SPANNING) {
                  const t = (this.w - this.normal.dot(vi.pos)) / this.normal.dot(new Vector_1.Vector().copy(vj.pos).sub(vi.pos));
        ...
        static fromPoints(a, b, c) {
          const n = new Vector_1.Vector().copy(b).sub(a).cross(new Vector_1.Vector().copy(c).sub(a)).normalize();
  ...
  // node_modules/three-csg-ts/lib/cjs/Polygon.js
  var require_Polygon = __commonJS({
    "node_modules/three-csg-ts/lib/cjs/Polygon.js"(exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
  ...
  // node_modules/three-csg-ts/lib/cjs/Vertex.js
  var require_Vertex = __commonJS({
    "node_modules/three-csg-ts/lib/cjs/Vertex.js"(exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
  ...
  // node_modules/three-csg-ts/lib/cjs/CSG.js
  var require_CSG = __commonJS({
    "node_modules/three-csg-ts/lib/cjs/CSG.js"(exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
      exports.CSG = void 0;
      var three_1 = require_three_shim();
      var NBuf_1 = require_NBuf();
      var Node_1 = require_Node();
      var Polygon_1 = require_Polygon();
      var Vector_1 = require_Vector();
      var Vertex_1 = require_Vertex();
      var CSG2 = class _CSG {
        constructor() {
          this.polygons = [];
        }
        ...
        static fromGeometry(geom, objectIndex) {
          ...
          for (let i = 0, pli = 0, l = index.length; i < l; i += 3, pli++) {
            ...
            for (let j = 0; j < 3; j++) {
              ...
              vertices[j] = new Vertex_1.Vertex(new Vector_1.Vector(x, y, z), new Vector_1.Vector(nx, ny, nz), new Vector_1.Vector(u, v, 0), colorattr && new Vector_1.Vector(colorattr.array[vp], colorattr.array[vp + 1], colorattr.array[vp + 2]));
            }
  ...
  // node_modules/three-csg-ts/lib/cjs/index.js
  var require_cjs = __commonJS({
    "node_modules/three-csg-ts/lib/cjs/index.js"(exports) {
      "use strict";
      ...
      Object.defineProperty(exports, "__esModule", { value: true });
      __exportStar(require_CSG(), exports);
    }
  });
